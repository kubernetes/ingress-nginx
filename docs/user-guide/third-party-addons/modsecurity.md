...
The directory `/etc/nginx/owasp-modsecurity-crs` contains the [https://github.com/SpiderLabs/owasp-modsecurity-crs](https://github.com/SpiderLabs/owasp-modsecurity-crs) repository.
