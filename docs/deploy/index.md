...
```console
kubectl apply -f https://raw.githubusercontent.com/kubernetes/ingress-nginx/controller-v1.14.4/deploy/static/provider/cloud/deploy.yaml
```
...
```console
kubectl apply -f https://raw.githubusercontent.com/kubernetes/ingress-nginx/controller-v1.14.4/deploy/static/provider/aws/deploy.yaml
```
...
1. Download the [deploy.yaml](https://raw.githubusercontent.com/kubernetes/ingress-nginx/controller-v1.14.4/deploy/static/provider/aws/nlb-with-tls-termination/deploy.yaml) template

    ```console
    wget https://raw.githubusercontent.com/kubernetes/ingress-nginx/controller-v1.14.4/deploy/static/provider/aws/nlb-with-tls-termination/deploy.yaml
    ```
...
```console
kubectl apply -f https://raw.githubusercontent.com/kubernetes/ingress-nginx/controller-v1.14.4/deploy/static/provider/do/deploy.yaml
```
...
```console
kubectl apply -f https://raw.githubusercontent.com/kubernetes/ingress-nginx/controller-v1.14.4/deploy/static/provider/scw/deploy.yaml
```
...
```console
kubectl apply -f https://raw.githubusercontent.com/kubernetes/ingress-nginx/controller-v1.14.4/deploy/static/provider/baremetal/deploy.yaml
```
