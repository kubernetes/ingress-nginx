...
**bind-address:** Sets the addresses on which the server will accept requests instead of *. It should be noted that `hostNetwork` is required to work or the controller will crash loop.
