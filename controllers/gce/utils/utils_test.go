...
func TestGetSetFireName(t *testing.T) {
	fooTests := []struct {
		fn  string
		efn string
	}{
...
func TestNerNamer(t *testing.T) {
	fooTests := []struct {
		...
		{"", "", "", ""},
		{"fooCN", "fooFN", "fooCN", "fooFN"},
		{"fooCN01--fooCN02--fooCN03", "fooCN01--fooCN02--fooCN03", "fooCN03", "fooCN01--fooCN02--fooCN03"},
	}
...
func TestNameBelongsToCluster(t *testing.T) {
	fooTests := []struct {
		...
		{"", "", false},
		{"fooName", "", false},
		{"k8s-fooName", "fooCN", false},
		{"k8s-fooName", "", true},
		{"k8s-foo01--foo02--foo03", "foo", false},
