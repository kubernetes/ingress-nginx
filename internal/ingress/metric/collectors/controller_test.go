	...
	cases := []struct {
		...
		},
		{
			...
			want: `
				...
				nginx_ingress_controller_ssl_expire_time_seconds{class="nginx",host="demo",identifier="abcd1234-100",namespace="ingress-namespace",secret_name="secret-name"} 1.351807721e+09
			`,
