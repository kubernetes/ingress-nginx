...
type Configuration struct {
	...
	// By default access logs go to /var/lib/nginx/access.log
	...
	// http://nginx.org/en/docs/ngx_core_module.html#error_log
	// By default error logs go to /var/lib/nginx/error.log
...
func NewDefault() Configuration {
	...
	cfg := Configuration{
		...
		AccessLogPath:              "/var/lib/nginx/access.log",
		WorkerCpuAffinity:          "",
		ErrorLogPath:               "/var/lib/nginx/error.log",
		BrotliLevel:                4,
