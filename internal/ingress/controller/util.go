...
func upstreamName(ingName string, namespace string, service string, port intstr.IntOrString) string {
	return fmt.Sprintf("%v-%v-%v-%v", ingName, namespace, service, port.String())
}
