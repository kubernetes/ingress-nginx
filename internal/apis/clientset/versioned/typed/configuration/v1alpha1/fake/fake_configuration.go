...
import (
	...
	v1alpha1 "k8s.io/ingress-nginx/internal/apis/configuration/v1alpha1"
)
...
var configurationsResource = schema.GroupVersionResource{Group: "nginx.ingress.kubernetes.io", Version: "v1alpha1", Resource: "configurations"}

var configurationsKind = schema.GroupVersionKind{Group: "nginx.ingress.kubernetes.io", Version: "v1alpha1", Kind: "Configuration"}
...
func (c *FakeConfigurations) UpdateStatus(configuration *v1alpha1.Configuration) (*v1alpha1.Configuration, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(configurationsResource, "status", c.ns, configuration), &v1alpha1.Configuration{})
