...
import (
	...
	"k8s.io/ingress-nginx/internal/apis/clientset/versioned/scheme"
...
// NginxV1alpha1Client is used to interact with features provided by the nginx.ingress.kubernetes.io group.
