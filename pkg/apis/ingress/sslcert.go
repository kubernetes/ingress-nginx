...
type SSLCert struct {
	...
	// CAFileContent contains the PEM representation of this CA file that will be used
	// by the dataplane
	...
	// CRLFileContent contains the PEM representation of this CA file that will be used
	// by the dataplane
