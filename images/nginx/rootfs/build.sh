...
# Check for recent changes: https://github.com/microsoft/mimalloc/compare/v2.2.4...master
export MIMALOC_VERSION=v2.2.4

# Check for recent changes: https://github.com/open-telemetry/opentelemetry-cpp/compare/v1.21.0...main
export OPENTELEMETRY_CPP_VERSION=v1.21.0

# Check for recent changes: https://github.com/open-telemetry/opentelemetry-proto/compare/v1.7.0...main
export OPENTELEMETRY_PROTO_VERSION=v1.7.0
