...
| controller.service.awsTargetGroupBinding | object | `{"arnMapping":{},"enabled":false}` | If want to use an existing AWS LoadBalancer, write the arn of the Target Group. controller.service.type: NodePort, and aws-load-balancer-controller must be installed to use. |
