...
![Version: 4.5.0](https://img.shields.io/badge/Version-4.5.0-informational?style=flat-square) ![AppVersion: 1.6.2](https://img.shields.io/badge/AppVersion-1.6.2-informational?style=flat-square)
...
| controller.image.digest | string | `"sha256:28109607594161ae703b8fc4d8c309b2267a2848885b9687f2080592ad790558"` |  |
| controller.image.digestChroot | string | `"sha256:80a81af6f51e9c8de4cfada41dfc81228315de4fd712450854863a306cb68d09"` |  |
| controller.image.image | string | `"ingress-nginx/controller"` |  |
| controller.image.pullPolicy | string | `"IfNotPresent"` |  |
| controller.image.registry | string | `"registry.k8s.io"` |  |
| controller.image.runAsUser | int | `101` |  |
| controller.image.tag | string | `"v1.6.2"` |  |
