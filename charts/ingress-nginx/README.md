...
| controller.admissionWebhooks.createSecretJob.volumes | list | `[]` | Volumes to set for the AdmissionWebhook createSecret Job. Example:   - name: certs     secret:       secretName: my-webhook-secret |
...
| controller.admissionWebhooks.patchWebhookJob.volumeMounts | list | `[]` | VolumeMounts to set for the AdmissionWebhook patchWebhook Job. Example:   - name: certs     mountPath: /etc/webhook/certs     readOnly: true |
| controller.admissionWebhooks.patchWebhookJob.volumes | list | `[]` | Volumes to set for the AdmissionWebhook patchWebhook Job. Example:   - name: certs     secret:       secretName: my-webhook-secret |
