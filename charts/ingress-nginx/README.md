...
| controller.admissionWebhooks.certManager.enabled | bool | `false` | Use certmanager to generate webhook certs |
| controller.admissionWebhooks.certificate | string | `"/usr/local/certificates/cert"` | Certificate path in pod with createSecretJob |
| controller.admissionWebhooks.certificate_dir | string | `"/usr/local/certificates/"` | Certificate directory path mounted in pod |
...
| controller.admissionWebhooks.key | string | `"/usr/local/certificates/key"` | Certificate key path in pod with createSecretJob |
>>>>>>> 7e123bae3 (Add loadBalancerClass params on svc and integration for certmanager for webhook)
