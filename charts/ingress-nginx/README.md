...
| controller.enableSSLPassthrough | bool | `false` | This configuration enables SSL Passthrough feature. See https://kubernetes.github.io/ingress-nginx/user-guide/tls/#ssl-passthrough Defaults to false |
